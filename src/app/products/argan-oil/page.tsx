        ...
        <div className="bg-neutral-50 min-h-screen text-slate-800 font-sans">
            ...
            <div className="max-w-4xl mx-auto px-4 py-16">
                ...
                <div className="flex flex-col md:flex-row gap-4 justify-center mb-16 flex-wrap">
                    ...
                    <a href="https://wa.me/9059622919?text=Hi%20Lilylab%2C%20I%20would%20like%20to%20order%20Argan%20Oil%20for%20local%20delivery%20in%20Halifax" target="_blank" rel="noopener noreferrer" className="flex-1 min-w-[200px] max-w-xs border border-amber-800 bg-amber-50 text-amber-900 text-center py-4 px-6 hover:bg-amber-100 transition-colors duration-300 uppercase tracking-wider text-sm font-medium rounded-sm">
